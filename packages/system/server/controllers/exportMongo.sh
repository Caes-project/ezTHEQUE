...
mongoexport --db mean-dev --collection users --csv -f name,email,livre_mag_revue,DVD,CD,caution,paiement,emprunt --out ./export/user.csv
mongoexport --db mean-dev --collection cds --csv -f title,auteur,editeur,interpretes,code_barre,dewey,date_acquis,date_hors_circu,ref,resume,tags --out ./export/livres.csv
