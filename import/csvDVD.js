...
transformer.on('readable', function(){
  ...
  while(data = transformer.read()){
    switch(data.ref.length){
      case 4: new_ref='50'+data.ref; break;
      case 3: new_ref='500'+data.ref; break;
      case 2: new_ref='5000'+data.ref; break;
      case 1: new_ref='50000'+data.ref; break;
    }
		switch(data.genre){
			case'ANI':genre='Animation';break;
			case'AVE':genre='Aventure/Action';break;
			case'COM':genre='Comédie';break;
			case'CDR':genre='Comédie dramatique';break;
			case'DOC':genre='Documentaire';break;
			case'FAN':genre='Fantastique/Horreur';break;
			case'HIS':genre='Historique/Guerre';break;
			case'MUS':genre='Musical';break;
			case'POL':genre='Policier/Suspense';break;
			case'SFI':genre='Science Fiction';break;
			case'THE':genre='Théatre';break;
			case'WES':genre='Western';break;
		}
    var newDVD = {
      'title' : data.titre,
    ...
    if(data.date_achat !== '0000-00-00' && data.date_achat !== 'NULL'){
      newDVD.date_acquis = data.date_achat;
    } 
    if(data.mis_hs !== '0000-00-00' && data.mis_hs !== 'NULL'){
      newDVD.date_hors_circu = data.mis_hs;
    }
